#include <bits/stdc++.h>
using namespace std;
#define UNASSIGNED 0  //empty cells in the grid
#define N 9  //Size will be NxN for grid
...
/*  N-queens algorithm 
It takes a partially filled-in grid and attempts to assign values to all 
unassigned locations in such a way to meet the constraints for solving the grid */
...
bool SolveSudoku(int grid[N][N])
{
	...
	for (int num = 1; num <= 9; num++)
	{
		...
		// And if-loop to check if looks promising
	...
	// This return triggers backtracking
	return false;
}
